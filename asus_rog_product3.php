...
<div id="page_name"> <h1 style="">ASUS ROG STRIX B460-H GAMING</h1></div>
	<div class="slidecontainer">
         ...
         <div class="mySlides fade">
         	...
         	<img src="img/asus rog strix b550f.png" style="width:80%">
              <div class="dis">
 ...
 <div class="product_details">
   <h1 style="color:white;">ASUS ROG STRIX B460-H GAMING</h1>
   <p style="color: white;">
    3 years Warranty<br>
...
Intel® B460<br>
Memory<br>
4 x DIMM, Max. 128GB, DDR4 2933/2800/2666/2400/2133 MHz Non-ECC, Un-buffered Memory *<br>
...
**Support DisplayPort 1.4 with max. resolution of 4096 x 2304 @60Hz. Please refer to www.intel.com for any update.<br>
Multi-GPU Support<br>
Supports AMD 2-Way CrossFireX Technology<br>
Expansion Slots<br>
Intel® 10th Gen Processors<br>
1 x PCIe 3.0 x16<br>
Intel® B460 Chipset<br>
1 x PCIe 3.0 x16 (x4 mode) *1<br>
3 x PCIe 3.0 x1 *2<br>
Storage<br>
Total supports 2 x M.2 slots and 6 x SATA 6Gb/s ports<br>
Intel® B460 Chipset :<br>
1 x M.2_1 socket 3, with M key, type 2242/2260/2280 storage devices support (SATA & PCIE 3.0 x 4 mode)*3<br>
1 x M.2_2 socket 3, with M key, type 2242/2260/2280/22110 storage devices support (PCIE 3.0 x 4 mode)<br>
...
<div class="product_2">
 ...
 <div class="product_image" style="width:300px height 300px"><img src="img/asus_rog/asus rog strix b460.png" width="400" height="400"></div>
