...
<div class="product_1">
 ...
 <a href="asus_rog_product1.php"><div class="product_1_image" style="width:200px height 200px"><img src="img/asus_rog/Rog maximus xii hero.png" width="300" height="300"></div></a> 
...
<div class="product_2">
   <a href="asus_rog_product2.php"><div class="product_1_image" style="width:200px height 200px"><img src="img/asus_rog/asus rog strix b550f.png" width="250" height="300"></div></a> 
  <div class="details"> <h3>Asus Rog Strix B550-F</h2><h2>40000 LKR </h2><h3 style="color:red;border: 1px solid white;border-radius: 30px;background-color: white">IN STOCK</h3></div>
  
</div>
<div class="product_3">
   <a href="asus_rog_product3.php"><div class="product_1_image" style="width:200px height 200px"><img src="img/asus_rog/asus rog strix b460.png" width="300" height="300"></div></a> 
  <div class="details"> <h3>Asus ROG Strix B460-H</h2><h2>31500 LKR </h2><h3 style="color:red;border: 1px solid white;border-radius: 30px;background-color: white">IN STOCK</h3></div>
  
</div>

<div class="product_4">

 <a href="asus_rog_product4.php"><div class="product_1_image" style="width:200px height 200px"><img src="img/asus_rog/ASUS STRIX GAMING GEFORCE RTX™ 3080 10GB.png" width="300" height="310"></div></a> 
  <div class="details"> <h3>Asus Strix  RTX™ 3080 </h2><h2>235000 LKR </h2><h3 style="color:red;border: 1px solid white;border-radius: 30px;background-color: white">IN STOCK</h3></div>
...
<div class="product_5">
   <a href="asus_rog_product5.php"><div class="product_1_image" style="width:200px height 200px"><img src="img/asus_rog/1587-1418-20200715220033-ROG-STRIX-GTX1650S-O4G-GAMING_box.png" width="300" height="300"></div></a> 
  <div class="details"> <h3>Asus Strix GTX 1650 </h2><h2>54,500 LKR </h2><h3 style="color:red;border: 1px solid white;border-radius: 30px;background-color: white">IN STOCK</h3></div>
  
</div>
<div class="product_6">
   <a href="asus_rog_product6.php"><div class="product_1_image" style="width:200px height 200px"><img src="img/asus_rog/ROG STRIX Z490-E with box_non aura.png" width="300" height="300"></div></a> 
  <div class="details"> <h3>Asus Rog Strix Z490-E</h2><h2>65,000 LKR </h2><h3 style="color:red;border: 1px solid white;border-radius: 30px;background-color: white">IN STOCK</h3></div>
  
</div>

<div class="product_7">

 <a href=""><div class="product_1_image" style="width:200px height 200px"><img src="img/asus_rog/Strix B450-F Gaming-with-box with Aura logo.png" width="300" height="300"></div></a> 
  <div class="details"> <h3>Asus Rog Strix B450-F </h2><h2>33,500 LKR </h2><h3 style="color:red;border: 1px solid white;border-radius: 30px;background-color: white">IN STOCK</h3></div>
